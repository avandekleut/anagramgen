...
setup(
  name = 'anagram-generator',         # How you named your package folder (MyLib)
  packages = ['anagram-generator'],   # Chose the same as "name"
  ...
  url = 'https://github.com/avandekleut/anagram-generator',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/avandekleut/anagram-generator/archive/v_01.tar.gz',    # I explain this later on
